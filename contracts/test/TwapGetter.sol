...
contract TwapGetter {
    ...
    function getPool(address tokenA, address tokenB, uint24 fee) public view returns (address pool) {
        return IUniswapV3Factory(uniV3Factory).getPool(tokenA, tokenB, fee);
    }
